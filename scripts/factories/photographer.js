function photographerFactory(data) {
    ...
    const { city,country,price,name, portrait,tagline,id,totalLikes  } = data;
    ...
    return { name, picture, getUserCardDOM,getUserHeaderDOM,getUserInfoBarDOM }
}
    ...
    function mediaFactory(data) {
        function getUserMediaDOM() {
            ...
            console.log(media,"mediafactory")
          media.forEach((item) => {
            const {
              id,
              photographerId,
